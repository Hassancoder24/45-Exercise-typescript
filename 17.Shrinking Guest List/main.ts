...
while (guestlist.length > 2) {
    ...
    console.log(`Salam, Sir ${removedGuest} Sorry, I can't invite you to dinner.`);
}
//invitation for last two guest
console.log("Invitation for Only Two guest");
guestlist.forEach(guest => console.log(`Assalam-o-Alekum ${guest}, you are still invited to dinner`));
